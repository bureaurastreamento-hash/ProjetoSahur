...
HELP = "\n".join([
    ...
    "G = ULTIMATE com a carga cheia: golpe final + DESPERTAR (20 s: +30% dano, +10% vel.) · Swift: DOMÍNIO DO TEMPO (cúpula: todos lentos, você rápido; sair quebra e te deixa MUITO rápido; 1× por despertar)",
